...
describe('mars', () => {
    it('should init mars', () => {
        const mars = new Mars(new Rover(new Coordinates(3, 4, Direction.NORTH)), []);
    ...
    it('should stop before hitting obstacle advancing', () => {
        const mars = new Mars(new Rover(new Coordinates(3, 4, Direction.NORTH)), [new Obstacle(4, 4)]);
    ...
    it('should stop before hitting obstacle backing', () => {
        const mars = new Mars(new Rover(new Coordinates(3, 4, Direction.NORTH)), [new Obstacle(1, 3)]);
